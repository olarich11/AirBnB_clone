#!/usr/bin/python3
"""Create unittests for models/user.py.
...
class TestUser_instantiation(unittest.TestCase):
    """Unittests for the testing instantiation in the User class."""
...
class TestUser_save(unittest.TestCase):
    """Unittests for the testing save method in the  class."""
...
class TestUser_to_dict(unittest.TestCase):
    """Unittests for the testing to_dict method in the User class."""
