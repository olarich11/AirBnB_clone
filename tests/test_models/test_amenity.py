#!/usr/bin/python3
""" Testing for unittests for the models/amenity.py.

Unittest classes:
    Test_for_Amenity_instantiation
    Test_Amenity_save
...
class Test_for_Amenity_instantiation(unittest.TestCase):
    """ Testing for instantiation process in the Amenity class. """
    ...
    def test_if_two_amenities_unique_ids(self):
        am1 = Amenity()
        am2 = Amenity()
        self.assertNotEqual(am1.id, am2.id)

    def test_if_two_amenities_different_created_at(self):
        am1 = Amenity()
        sleep(0.05)
        am2 = Amenity()
        self.assertLess(am1.created_at, am2.created_at)

    def test_if_two_amenities_different_updated_at(self):
        am1 = Amenity()
        sleep(0.05)
        am2 = Amenity()
...
class TestAmenity_save(unittest.TestCase):
    """ Testing the save method in the Amenity class."""
...
class TestAmenity_to_dict(unittest.TestCase):
    """Testing the to_dict method in the Amenity class."""
