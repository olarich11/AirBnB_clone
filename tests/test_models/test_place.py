#!/usr/bin/python3
"""Create unittests for models/place.py.
...
class TestPlace_instantiation(unittest.TestCase):
    """Unittests for the testing instantiation in the Place class."""
...
class TestPlace_save(unittest.TestCase):
    """Unittests for the testing save method in the Place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unittests for the testing to_dict method in the Place class."""
