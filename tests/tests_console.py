#!/usr/bin/python3
"""Create unittests for console.py.
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests for verifying HBNB command interpreter help messages."""

    def test_help_quit(self):
        h = "Use the Quit command to terminate the program."
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_show(self):
        h = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
             "Present the string representation of a class instance of"
             " a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_destroy(self):
        h = ("Usage: destroy <class> <id> or <class>.destroy(<id>)\n        "
             "erase a class instance of a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_all(self):
        h = ("Usage: all or all <class> or <class>.all()\n        "
             ...
             ".\n        If no class is specified, present all instantiated "
             "objects.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_count(self):
        h = ("Usage: count <class> or <class>.count()\n        "
             "Recover the number of instances of a given class.")
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests to verify the exit function of the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests to validate the command in the HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests to assess the show command in the HBNB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for the destroy command in the HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unittests to check the entire HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests for update command in the HBNB interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests for the count method in HBNB comand interpreter."""
